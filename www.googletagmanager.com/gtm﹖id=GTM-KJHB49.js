  ...
  var data = {
    resource: {
      ...
      macros: [
        ...
        },
        {
          ...
          vtp_name: "ga.video.player.trigger",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: true,
          vtp_defaultValue: "Not Specified",
          vtp_name: "ga.video.content.contentId",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: true,
          vtp_defaultValue: "Not Specified",
          vtp_name: "ga.video.player.version",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: true,
          vtp_defaultValue: "Not Specified",
          vtp_name: "ga.video.player.context",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: true,
          vtp_defaultValue: "Not Specified",
          vtp_name: "ga.video.content.network",
        },
        { function: "__c", vtp_value: "UA-3705233-1" },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "ga.event.action",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "ga.event.category",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "ga.event.label",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: true,
          vtp_defaultValue: "Not Specified",
          vtp_name: "ga.event.value",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "page-data.Template",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
        ...
        },
        {
          ...
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "page-data.Author",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "page-data.CPID",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "page-data.ContentType",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "page-data.MostRequestedStory",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "page-data.OriginalPageName",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "page-data.OriginalPublishDate",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "page-data.SiteSection",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
        ...
        },
        {
          ...
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "page-data.UpdateDate",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "page-data.WordCount",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
        ...
        },
        {
          ...
          vtp_setDefaultValue: true,
          vtp_input: ["macro", 28],
          vtp_defaultValue: "UA-3705233-1",
          vtp_map: [
            "list",
            ["map", "key", "false", "value", "UA-3705233-1"],
            ["map", "key", "true", "value", "UA-3705233-1"],
          ],
        },
        { function: "__j", vtp_name: "zdconsent.gdprApplies" },
        { function: "__j", vtp_name: "zdconsent.consentGiven" },
        {
          function: "__jsm",
          vtp_javascript: [
            "template",
        ...
        { function: "__k", vtp_decodeCookie: false, vtp_name: "_ga" },
        {
          ...
          vtp_javascript: [
            ...
            ';if(a)return a=a.split("."),a[a.length-2]+"."+a[a.length-1]})();',
          ],
        },
        {
          function: "__jsm",
        ...
        },
        {
          ...
          vtp_javascript: [
            "template",
            '(function(){var a=new Date,c=-a.getTimezoneOffset(),d=0\u003C=c?"+":"-",b=function(a){a=Math.abs(Math.floor(a));return(10\u003Ea?"0":"")+a};return a.getFullYear()+"-"+b(a.getMonth()+1)+"-"+b(a.getDate())+"T"+b(a.getHours())+":"+b(a.getMinutes())+":"+b(a.getSeconds())+"."+b(a.getMilliseconds())+d+b(c\/60)+":"+b(c%60)})();',
          ],
        },
        {
          function: "__jsm",
        ...
        {
          function: "__j",
          convert_undefined_to: "not_found",
          vtp_name: "window.legacy_template",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
        ...
        },
        {
          ...
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "videoPlayType",
        },
        {
          function: "__j",
          convert_undefined_to: "not_found",
          vtp_name: "window.template",
        },
        {
          function: "__gas",
          ...
          vtp_autoLinkDomains: "mashable.com",
          vtp_cookieDomain: "auto",
          vtp_doubleClick: false,
          vtp_setTrackerName: true,
          vtp_fieldsToSet: [
            "list",
            ["map", "fieldName", "anonymizeIp", "value", ["macro", 32]],
            ["map", "fieldName", "allowAdFeatures", "value", ["macro", 37]],
          ],
          vtp_trackerName: "",
          ...
          vtp_dimension: [
            ...
            ["map", "index", "102", "dimension", ["macro", 20]],
            ["map", "index", "103", "dimension", ["macro", 19]],
            ["map", "index", "37", "dimension", ["macro", 21]],
            ["map", "index", "38", "dimension", ["macro", 22]],
            ["map", "index", "39", "dimension", ["macro", 23]],
            ["map", "index", "101", "dimension", ["macro", 24]],
            ["map", "index", "43", "dimension", ["macro", 26]],
            ["map", "index", "44", "dimension", ["macro", 27]],
            ["map", "index", "45", "dimension", ["macro", 34]],
            ["map", "index", "46", "dimension", ["macro", 35]],
            [
              "map",
              "index",
              "47",
              "dimension",
              ["template", ["macro", 38], " - ", ["macro", 39]],
            ],
            ["map", "index", "48", "dimension", ["macro", 36]],
            ["map", "index", "2", "dimension", ["macro", 40]],
            ["map", "index", "53", "dimension", ["macro", 41]],
            ["map", "index", "54", "dimension", ["macro", 42]],
            ["map", "index", "55", "dimension", ["macro", 43]],
            ["map", "index", "56", "dimension", ["macro", 44]],
        ...
        },
        {
          ...
          vtp_setDefaultValue: true,
          vtp_defaultValue: "false",
          vtp_name: "scroll-enable",
        },
        { function: "__j", vtp_name: "zdconsent.optins.ga" },
        {
          function: "__k",
          vtp_decodeCookie: false,
          vtp_name: "_evidon_suppress_notification_cookie",
        },
        {
          function: "__jsm",
          vtp_javascript: [
        ...
        },
        {
          ...
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "CommerceClicks",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "ModuleClicks",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
          vtp_setDefaultValue: false,
          vtp_name: "ProductClicks",
        },
        {
          function: "__v",
          vtp_dataLayerVersion: 2,
        ...
        {
          function: "__d",
          vtp_elementSelector: "#breadcrumbs li:last-child",
      ...
      tags: [
        {
          ...
          vtp_measurementIdOverride: "G-2Y85WP1X8R",
          vtp_eventSettingsVariable: ["macro", 3],
        ...
        },
        {
          ...
          vtp_uniqueTriggerId: "2425178_93",
        ...
        },
        {
          ...
          once_per_load: true,
          vtp_html:
            '\u003Cscript type="text\/gtmscript"\u003EsetTimeout(function(){var a=document.createElement("script"),b=document.getElementsByTagName("script")[0];a.src=document.location.protocol+"\/\/script.crazyegg.com\/pages\/scripts\/0010\/4648.js?"+Math.floor((new Date).getTime()\/36E5);a.async=!0;a.type="text\/javascript";b.parentNode.insertBefore(a,b)},1);\u003C\/script\u003E',
        ...
        },
        {
          ...
          once_per_event: true,
          vtp_html:
            '\n\u003Cscript type="text\/gtmscript" id="cbeattag"\u003Evar _sf_startpt=(new Date).getTime(),_sf_async_config=_sf_async_config||{};window._sf_async_config.uid=54814;window._sf_async_config.domain="pcmag.com";window._sf_async_config.useCanonical=!0;\n(function(){window._sf_async_config.sections=typeof category!=="undefined"?category:"";window._sf_async_config.authors=typeof author!=="undefined"?author:"";(function(){function b(){window._sf_endpt=(new Date).getTime();var a=document.createElement("script");a.setAttribute("language","javascript");a.setAttribute("type","text\/javascript");a.setAttribute("src","\/\/static.chartbeat.com\/js\/chartbeat.js");document.body.appendChild(a)}var c=window.onload;window.onload=typeof window.onload!="function"?b:\nfunction(){c();b()}})()})();\u003C\/script\u003E\n',
          vtp_supportDocumentWrite: false,
          vtp_enableIframeMode: false,
          vtp_enableEditJsMacroBehavior: false,
          tag_id: 48,
        },
        {
          ...
          once_per_event: true,
          vtp_html:
            '\u003Cscript\u003Evar _comscore=_comscore||[];_csconfig={c1:"2",c2:"6036202"};"undefined"!==typeof window.zdconsent\u0026\u0026window.zdconsent\u0026\u0026window.zdconsent.gdprApplies\u0026\u0026(_csconfig.cs_ucfr=window.zdconsent.optins?window.zdconsent.optins.comscore:0);_comscore.push(_csconfig);(function(){var a=document.createElement("script"),b=document.getElementsByTagName("script")[0];a.async=!0;a.src="https:\/\/sb.scorecardresearch.com\/beacon.js";b.parentNode.insertBefore(a,b)})();\u003C\/script\u003E\n',
        ...
        },
        {
          ...
          once_per_event: true,
          vtp_html:
            '\u003Cdiv id="amzn-assoc-ad-d252c7e5-02be-4b56-911e-079e3ef1e504"\u003E\u003C\/div\u003E\u003Cscript id="amzntag" async data-gtmsrc="\/\/z-na.amazon-adsystem.com\/widgets\/onejs?MarketPlace=US\u0026amp;adInstanceId=d252c7e5-02be-4b56-911e-079e3ef1e504" type="text\/gtmscript"\u003E\u003C\/script\u003E',
          vtp_supportDocumentWrite: false,
          vtp_enableIframeMode: false,
          vtp_enableEditJsMacroBehavior: false,
          tag_id: 61,
        },
        {
          ...
          once_per_event: true,
          vtp_html:
            '\u003Cscript id="truamtag" data-gtmsrc="\/\/tru.am\/scripts\/custom\/ziffmedia.js" async type="text\/gtmscript"\u003E\u003C\/script\u003E',
          vtp_supportDocumentWrite: false,
          vtp_enableIframeMode: false,
          vtp_enableEditJsMacroBehavior: false,
          tag_id: 169,
        },
        {
          ...
          once_per_event: true,
          vtp_html:
            "\u003Cscript\u003EsetTimeout(function(){var a=\"\\x3ca href\\x3d'tel:1-877-462-3714' rel\\x3d'nofollow' class\\x3d'md:hidden group no-underline flex flex-wrap w-full flex-shrink-1 items-end'\\x3e\\x3cdiv class\\x3d'mt-2 text-base font-brand font-semibold text-gray-darkest leading-tight w-full'\\x3e\\x3cspan class\\x3d'flex justify-center inline-block max-w-48 w-1\/2 text-base rounded-full bg-white border border-red-base items-center text-red-base py-2 group-hover:bg-red-darker group-hover:text-white uppercase font-semibold tracking-wider group-hover:shadow-lg transition-all group-hover:-top-px top-0 relative'\\x3e\\x3csvg aria-hidden\\x3d'true' focusable\\x3d'false' data-prefix\\x3d'fas' data-icon\\x3d'phone' role\\x3d'img' xmlns\\x3d'http:\/\/www.w3.org\/2000\/svg' viewBox\\x3d'0 0 512 512' class\\x3d'w-3 h-3 inline-block mx-2'\\x3e\\x3cpath fill\\x3d'currentColor' d\\x3d'M493.4 24.6l-104-24c-11.3-2.6-22.9 3.3-27.5 13.9l-48 112c-4.2 9.8-1.4 21.3 6.9 28l60.6 49.6c-36 76.7-98.9 140.5-177.2 177.2l-49.6-60.6c-6.8-8.3-18.2-11.1-28-6.9l-112 48C3.9 366.5-2 378.1.6 389.4l24 104C27.1 504.2 36.7 512 48 512c256.1 0 464-207.5 464-464 0-11.2-7.7-20.9-18.6-23.4z' class\\x3d''\\x3e\\x3c\/path\\x3e\\x3c\/svg\\x3e CALL ADT PULSE\\x3c\/span\\x3e\\x3cdiv class\\x3d'pt-1 h-8 text-xs font-brand font-normal text-gray-darker w-1\/2 pl-4'\\x3e877-462-3714\\x3c\/div\\x3e\\x3c\/a\\x3e\",\nb=\"\\x3ca href\\x3d'tel:1-833-809-6767' rel\\x3d'nofollow' class\\x3d'md:hidden group no-underline flex flex-wrap w-full flex-shrink-1 items-end'\\x3e\\x3cdiv class\\x3d'mt-2 text-base font-brand font-semibold text-gray-darkest leading-tight w-full'\\x3e\\x3cspan class\\x3d'flex justify-center inline-block max-w-48 w-1\/2 text-base rounded-full bg-white border border-red-base items-center text-red-base py-2 group-hover:bg-red-darker group-hover:text-white uppercase font-semibold tracking-wider group-hover:shadow-lg transition-all group-hover:-top-px top-0 relative'\\x3e\\x3csvg aria-hidden\\x3d'true' focusable\\x3d'false' data-prefix\\x3d'fas' data-icon\\x3d'phone' role\\x3d'img' xmlns\\x3d'http:\/\/www.w3.org\/2000\/svg' viewBox\\x3d'0 0 512 512' class\\x3d'w-3 h-3 inline-block mx-2'\\x3e\\x3cpath fill\\x3d'currentColor' d\\x3d'M493.4 24.6l-104-24c-11.3-2.6-22.9 3.3-27.5 13.9l-48 112c-4.2 9.8-1.4 21.3 6.9 28l60.6 49.6c-36 76.7-98.9 140.5-177.2 177.2l-49.6-60.6c-6.8-8.3-18.2-11.1-28-6.9l-112 48C3.9 366.5-2 378.1.6 389.4l24 104C27.1 504.2 36.7 512 48 512c256.1 0 464-207.5 464-464 0-11.2-7.7-20.9-18.6-23.4z' class\\x3d''\\x3e\\x3c\/path\\x3e\\x3c\/svg\\x3e CALL VIVINT\\x3c\/span\\x3e\\x3cdiv class\\x3d'pt-1 h-8 text-xs font-brand font-normal text-gray-darker w-1\/2 pl-4'\\x3e833-809-6767\\x3c\/div\\x3e\\x3c\/a\\x3e\";\nitemADT=document.querySelector('a[href*\\x3d\"043xSONp84HgLA8bmQ0WKzI\"]');itemVivint=document.querySelector('a[href*\\x3d\"07FHZU40c0Le8Rt1ZtC08bX\"]');itemADT\u0026\u0026itemADT.insertAdjacentHTML(\"afterend\",a);itemVivint\u0026\u0026itemVivint.insertAdjacentHTML(\"afterend\",b)},250);\u003C\/script\u003E",
          vtp_supportDocumentWrite: true,
          vtp_enableIframeMode: false,
          vtp_enableEditJsMacroBehavior: false,
          vtp_usePostscribe: true,
      ...
      predicates: [
        ...
        { function: "_eq", arg0: ["macro", 0], arg1: "gtm.load" },
        {
          function: "_sw",
          arg0: ["macro", 4],
          arg1: "https:\/\/www.pcmag.com\/picks\/the-best-laptops",
        },
        { function: "_cn", arg0: ["macro", 5], arg1: "mashable.com" },
        {
          function: "_cn",
          arg0: ["macro", 4],
          arg1: "picks\/the-best-smart-home-security-systems",
        },
      ],
      rules: [
        [
          ...
          [
            ...
            [
              ...
              [
                ...
                [5, [46, ["o", "product_id"], ["o", "product_category"], [4]]],
                [9, [46, [4]]],
              ],
            ],
            [
              ...
              [
                ...
                [
                  "e",
                  [0, "Firing Pinterest event: ", [17, [15, "a"], "eventName"]],
                ],
                ["e", "Event Data:"],
                ["e", [15, "m"]],
    ...
    permissions: {
      ...
      __pntr: {
        access_globals: {
          keys: [
            { key: "pintrk", read: true, write: true, execute: true },
            { key: "pintrk.queue", read: true, write: true, execute: true },
          ],
        },
    ...
    security_groups: {
      ...
      google: ["__c", "__cid", "__ctv", "__e", "__gtes", "__j", "__sdl"],
              ...
              f.prototype.R = function (a) {
                ...
                w(a, function (g) {
                  ...
                  if (g.g) {
                    ...
                    d.push(g.text), k.push(g.type === "endTag" ? g.text : "");
                });
                return {
                  wa: a,
                  raw: c.join(""),
...
*/
  ...
  Te[8] = function (a) {
    ...
    switch (typeof a) {
      ...
      case "number":
        return " " + a + " ";
      default:
        return "'" + String(String(a)).replace(Ye, Pe) + "'";
    }
  };
  var ff =
  ...
  Ki.ob = "dataLayer";
  Ki.Dn =
    "ChAIgPW6ugYQ57nr1N2Y3r8xEiMA1yD4FIliOjM0nf1xqFrjM6a+QUXmQ6e5K8eSP5tTqTDvqhoCRgk\x3d";
  var Mi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  try {
    pl = JSON.parse(
      Ta(
        "eyIwIjoiRlIiLCIxIjoiIiwiMiI6ZmFsc2UsIjMiOiJnb29nbGUuZnIiLCI0IjoicmVnaW9uMSIsIjUiOmZhbHNlLCI2Ijp0cnVlLCI3IjoiYWRfc3RvcmFnZXxhbmFseXRpY3Nfc3RvcmFnZXxhZF91c2VyX2RhdGF8YWRfcGVyc29uYWxpemF0aW9uIn0",
      ),
    );
  } catch (a) {
    V(123), ol(2), (pl = {});
    ...
    (function () {
      ...
      function b(f, g, k) {
        var m = {},
          ...
          p = function (v, t, w) {
            ...
            if (v) {
              m.items = m.items || [];
              for (var x = {}, y = 0; y < v.length; x = { ff: void 0 }, y++)
                (x.ff = {}),
                  ib(
                    v[y],
                    (function (C) {
      ...
      (function (f) {
        ...
        if (z(g) && g.indexOf("G-") === 0) {
          ...
          var u = sK(f.vtp_eventParameters, "name", "value"),
            v;
