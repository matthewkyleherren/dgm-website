(function () {
  ...
  window.PARSELY.__template_apikey = "robbreport.com";
...
/*! parsely-js-api - v2.3.0 - 2024-02-14
...
(window.PARSELY = window.PARSELY || {}),
  ...
  (function () {
    ...
    var o = {
      ...
      track_ip_addresses:
        null == PARSELY.__template_track_ips || PARSELY.__template_track_ips,
    ...
    function i(e, t) {
      ...
      switch (
        (p &&
          ...
          (p = p.toJSON(e)),
        "function" == typeof d && (p = d.call(t, e, p)),
        _typeof(p))
      ) {
        case "string":
          return n(p);
  ...
  (function (e, t) {
    ...
    function o(e, t, n, i) {
      if (y.acceptData(e)) {
        ...
        if (
          ...
          return (
            c || (c = s ? (e[a] = d.pop() || y.guid++) : a),
            u[c] || (u[c] = s ? {} : { toJSON: y.noop }),
            ("object" !== _typeof(t) && "function" != typeof t) ||
              (i
                ? (u[c] = y.extend(u[c], t))
                : (u[c].data = y.extend(u[c].data, t))),
            (r = u[c]),
            i || (r.data || (r.data = {}), (r = r.data)),
            n !== undefined && (r[y.camelCase(t)] = n),
            "string" == typeof t
              ? null == (o = r[t]) && (o = r[y.camelCase(t)])
              : (o = r),
            o
          );
      }
    ...
    (y.fn = y.prototype =
      ...
      (y.extend = y.fn.extend =
        function () {
          var e,
            ...
            d = !1;
          for (
            "boolean" == typeof a && ((d = a), (a = arguments[s] || {}), s++),
              "object" === _typeof(a) || y.isFunction(a) || (a = {}),
              s === u && ((a = this), s--);
            s < u;
            s++
          )
            if (null != (o = arguments[s]))
              for (i in o)
                (e = a[i]),
                  a !== (n = o[i]) &&
                    (d && n && (y.isPlainObject(n) || (t = y.isArray(n)))
                      ? (t
                          ? ((t = !1), (r = e && y.isArray(e) ? e : []))
                          : (r = e && y.isPlainObject(e) ? e : {}),
                        (a[i] = y.extend(d, r, n)))
                      : n !== undefined && (a[i] = n));
          return a;
        }),
      y.extend({
        ...
        isPlainObject: function (e) {
          ...
          if (g.ownLast) for (t in e) return v.call(e, t);
          for (t in e);
    ...
    ((y.fn.init = function (e, t) {
      ...
      if ("string" == typeof e) {
        ...
        if (y.isFunction(e))
          return "undefined" != typeof S.ready ? S.ready(e) : e(y);
      }
      return (
    ...
    y.extend({
      ...
      hasData: function (e) {
        return (
          !!(e = e.nodeType ? y.cache[e[y.expando]] : e[y.expando]) && !i(e)
        );
      },
      data: function (e, t, n) {
        return o(e, t, n);
    ...
    !(function () {
      ...
      for (t in { submit: !0, change: !0, focusin: !0 })
        (n = "on" + t),
          (g[t + "Bubbles"] = n in e) ||
            (i.setAttribute(n, "t"),
            (g[t + "Bubbles"] = !1 === i.attributes[n].expando));
      i = null;
    })();
    var R = /^key/,
    ...
    (y.event = {
            ...
            n.handler && ((n = (u = n).handler), (o = u.selector)),
              ...
              (c = h.handle) ||
                ((c = h.handle =
                  function (e) {
                    return _typeof(y) === O ||
                      (e && y.event.triggered === e.type)
                      ? undefined
                      : y.event.dispatch.apply(c.elem, arguments);
                  }).elem = e),
              s = (t = (t || "").match(x) || [""]).length;
            s--;
            ...
            (p = g = (r = C.exec(t[s]) || [])[1]),
              ...
              p &&
                ...
                (f = a[p]) ||
                  ...
                  (d.setup && !1 !== d.setup.call(e, i, v, c)) ||
                    (e.addEventListener
      ...
      trigger: function (t, n, i, o) {
        ...
        if (
          ...
          3 !== i.nodeType &&
            8 !== i.nodeType &&
            !T.test(p + y.event.triggered) &&
            (p.indexOf(".") >= 0 &&
              ((p = (g = p.split(".")).shift()), g.sort()),
            (a = p.indexOf(":") < 0 && "on" + p),
            (t = t[y.expando]
              ? t
              : new y.Event(p, "object" === _typeof(t) && t)),
            (t.isTrigger = o ? 2 : 3),
            (t.namespace = g.join(".")),
          ...
          if (!o && !d.noBubble && !y.isWindow(i)) {
            for (
              u = d.delegateType || p, T.test(u + p) || (s = s.parentNode);
              s;
              s = s.parentNode
            )
              f.push(s), (c = s);
          ...
          for (l = 0; (s = f[l++]) && !t.isPropagationStopped(); )
            (t.type = l > 1 ? u : d.bindType || p),
              (r =
                (y._data(s, "events") || {})[t.type] && y._data(s, "handle")) &&
                r.apply(s, n),
              (r = a && s[a]) &&
                r.apply &&
                y.acceptData(s) &&
      ...
      dispatch: function (e) {
        ...
        if (
          ...
          for (
            a = y.event.handlers.call(this, e, u), t = 0;
            ...
            for (
              ...
              (e.namespace_re && !e.namespace_re.test(i.namespace)) ||
                ...
                (e.data = i.data),
                (n = (
                  (y.event.special[i.origType] || {}).handle || i.handler
      ...
      fix: function (e) {
        ...
        for (
          a ||
            (this.fixHooks[o] = a =
              L.test(o) ? this.mouseHooks : R.test(o) ? this.keyHooks : {}),
    ...
    y.param = function (e, t) {
      ...
      if (
        (t === undefined && (t = y.ajaxSettings && y.ajaxSettings.traditional),
      ...
      return (
        ...
        i(t, [
            ...
            value: function (e) {
              !this._unsavedChanges.indexOf(e) > -1 &&
                (0 === this._unsavedChanges.length &&
                  addEventListener("beforeunload", y),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              t > -1 &&
                ...
                0 === this._unsavedChanges.length &&
                  removeEventListener("beforeunload", y));
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              switch (
                (g && clearTimeout(this._safariBeforeUnloadTimeout), e.type)
              ) {
                case "pageshow":
                case "resume":
          ...
          ? t +
              ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(
                ...
                function (e) {
                  return (
                    e ^
                    (n.getRandomValues(new Uint8Array(1))[0] & (15 >> (e / 4)))
                  ).toString(16);
                },
              )
          : t +
          ...
          if (void 0 === r) {
            ...
            !1 !== e.optout_disabled_cookies &&
              ...
              void 0 === a && null !== s
                ? ((a = s),
                  i.log(
                    "No existing visitor ID found, using UUID from config: " +
                      a,
                  ))
  ...
  (function () {
    ...
    function t(e) {
      ...
      for (
        var i = 0, o = e.parentNode ? e.parentNode.childNodes : [], a = 0;
        a < o.length;
        a++
      ) {
        var s = o[a];
        ...
        (e.engagedTime.sendHeartbeat = function (t, n, r, a) {
          (t = void 0 === t ? 0 : t),
            ...
            (void 0 === n || !0 === n) &&
              ...
              "undefined" != typeof PARSELY.beacon.pixel &&
              "function" == typeof PARSELY.beacon.pixel.beacon
                ...
                : console.warn(
                    "PARSELY.beacon.pixel.beacon was called with action='heartbeat' while PARSELY.beacon was undefined.",
                  ));
        }),
  ...
  (function () {
    ...
    (e.videoPlaying = !1),
      (e.video = e.video || {}),
      (e.video.trackedVideos = {}),
      (e.video._subscribedElements = []),
      (e.video.skipRegex = new RegExp("data:video/\\w+;base64,.+")),
      window._parselyIsTest && (e.video._embedMap = {});
    var t = function (t) {
      ...
      i = function (n) {
        return function (i, o, r, a) {
          if (
            ((i = void 0 === i ? 0 : i),
            (o = void 0 === o ? e.enableHeartbeats : o),
            (a = void 0 !== a && a),
            void 0 === o || !0 === o)
          ) {
            ...
            "undefined" != typeof PARSELY.beacon.pixel &&
            "function" == typeof PARSELY.beacon.pixel.beacon
              ? (PARSELY.beacon.pixel.beacon(d, undefined, a),
                e.$.isFunction(e.onHeartbeat) && e.onHeartbeat(i),
                (s._heartbeatsSent += 1))
              : console.warn(
                  "PARSELY.beacon.pixel.beacon was called with action='vheartbeat' while PARSELY.beacon was undefined.",
                );
          }
        };
      },
      o = function () {
        for (
          var t, n, i, o = window, r = 0;
          r < e.video._strategies.length;
          r++
        ) {
          ...
          for (var a = 0; a < t.searchTags.length; a++) {
            ...
            for (var s = 0; s < n.length; s++)
              (i = n[s]),
                -1 === e.video._subscribedElements.indexOf(i) &&
                  t.verify(i) &&
                  (i.id ||
                    i.setAttribute(
                      "id",
                      t.platform + "-" + e.util.getRandomInt(0, 9999999),
                    ),
                  !1 !== t.subscribe(i) &&
                    ("undefined" == typeof t._subscribedElements &&
                      (t._subscribedElements = []),
                    t._subscribedElements.push(i),
                    e.video._subscribedElements.push(i)));
          }
        }
      };
    ...
    var r = function (t, n, o) {
      if (
        (void 0 === n && (n = {}),
        n.hasOwnProperty("link") || (n.link = t),
        e.video.trackedVideos[t])
      ) {
        for (var r in n)
          n.hasOwnProperty(r) && (e.video.trackedVideos[t].metadata[r] = n[r]);
    ...
    (e.video._storeApiRoot = function (t, n) {
      window._parselyIsTest &&
        !e.video._embedMap.hasOwnProperty(t) &&
        (e.video._embedMap[t] = n);
    }),
          ...
          if (null === (i + "").match(e.video.skipRegex)) {
            ...
            s.hasStartedPlaying ||
              ...
              "function" == typeof PARSELY.beacon.pixel.beacon
                ...
                : console.warn(
                    "PARSELY.beacon.pixel.beacon was called with action='videostart' while PARSELY.beacon was undefined.",
                  )),
              (s.isPlaying = !0),
              n();
      ...
      (e.video.trackPause = function (t, i, o) {
        void 0 !== t
          ? ((r(t, i, o).isPlaying = !1), n())
          : e.console.log("no video id provided; trackPause event failed");
      }),
      ...
      (e.video.clear = function () {
        ...
        for (t = 0; t < e.video._strategies.length; t++)
          delete e.video._strategies[t]._subscribedElements;
      }),
      (e.video.addStrategy = function (t) {
        for (var n = 0; n < e.video._strategies.length; n++)
          if (e.video._strategies[n].platform === t.platform)
            return void e.console.log(
              "Strategy '" + t.platform + "' already registered",
            );
        e.video._strategies.unshift(t),
          (e.video.hasOwnProperty("autotrack") && !1 === e.video.autotrack) ||
            o();
      }),
      "undefined" == typeof e.video.onPlay &&
        (e.video.onPlay = function (t, n, i) {
          e.video.trackPlay(n, i);
        }),
      "undefined" == typeof e.video.onPause &&
        (e.video.onPause = function (t, n) {
    ...
    var a = {
      ...
      subscribe: function (t) {
        if ("function" != typeof window.MediaElement)
          return (
            e.console.log(
              "Detected mediaelement.js embed butwindow.MediaElement is not accesible.",
            ),
            !1
          );
        var n = function (n) {
          ...
          i = function (t, n) {
            e.video.onPause(t, t.currentSrc),
              !0 === n && e.video.reset(t.currentSrc);
          };
        new window.MediaElement(t.id, {
          success: function (o) {
            e.video._storeApiRoot(t.id, o),
              o.addEventListener("loadedmetadata", function () {
                o.addEventListener("play", function () {
                  ...
                  e.console.log(
                    "Subscribed to mediaelementjs embed with ID '" + t.id + "'",
                  );
              });
          },
        });
    ...
    var s = {
      ...
      verify: function (e) {
        return (
          -1 !== e.className.indexOf("vjs-tech") ||
          -1 !== e.className.indexOf("video-js")
        );
      },
      subscribe: function (t) {
        if ("function" != typeof window.videojs)
          return (
            e.console.log(
              "Detected video.js embed but window.videojs is not accesible.",
            ),
            !1
          );
        var n,
          ...
          r = function (n) {
            e.console.log("videojs: Attempting to set listeners"),
              ...
              !1 === n.paused() && i(n),
              e.console.log(
                "videojs: Subscribed to videojs embed with ID '" + t.id + "'",
              );
          };
        "undefined" != typeof window.videojs.getPlayer
          ? (e.console.log("videojs: Using getPlayer() to attach to player"),
            (n = window.videojs.getPlayer(t.id)))
          : (e.console.log("videojs: Using videojs() to attach to player"),
            (n = window.videojs(t.id))),
          void 0 !== n &&
            (window.isNaN(n.duration())
              ? (e.console.log("videojs: Setting loadedmetadata listener"),
                n.on("loadedmetadata", function () {
                  r(n);
                }))
              : (e.console.log("videojs: Player metadata already loaded"),
                r(n)));
      },
    };
    ...
    var u = {
      ...
      subscribe: function (t) {
        if ("object" !== _typeof(window.$pdk))
          return (
            e.console.log(
              "Detected ThePlatform embed but window.$pdk is not accesible.",
            ),
            !1
          );
        e.video._storeApiRoot(t.id, window.$pdk),
          window.$pdk.controller.addEventListener(
            "OnReleaseStart",
            function (t) {
              var n = {
          ...
          window.$pdk.controller.addEventListener("OnMediaEnd", function (t) {
            e.video.onPause(window.$pdk, t.data.clip.baseClip.guid),
              e.video.reset(t.data.clip.baseClip.guid);
          }),
          e.console.log(
            "Subscribed to ThePlatform embed with ID '" + t.id + "'",
          );
      },
    };
    ...
    var d = {
      ...
      subscribe: function (t) {
        if ("object" !== _typeof(window.Vimeo))
          return (
            e.console.log(
              "Detected Vimeo embed but window.Vimeo is not accesible.",
            ),
            !1
          );
    ...
    var c = {
      ...
      verify: function (e) {
        return (
          -1 !== e.className.indexOf("jwplayer") &&
          -1 !== e.className.indexOf("jw-")
        );
      },
      subscribe: function (t) {
        if ("function" != typeof window.jwplayer)
          return (
            e.console.log(
              "Detected JWPlayer embed but window.jwplayer is not accesible.",
            ),
            !1
          );
        ...
        n.on("play", function () {
          ...
          "undefined" != typeof i.tags &&
            i.tags.length > 0 &&
            (r.tags = i.tags.split(",")),
            "undefined" != typeof r.pub_date_tmsp &&
              Number.isInteger(r.pub_date_tmsp) &&
              (r.pub_date_tmsp *= 1e3),
            i.hasOwnProperty("author") && (r.author = i.author),
            i.hasOwnProperty("section") && (r.section = i.section),
            e.video.onPlay(n, i.mediaid, r);
        }),
          n.on("pause", function () {
          ...
          n.on("complete", function () {
            e.video.onPause(n, n.getPlaylistItem().mediaid),
              e.video.reset(n.getPlaylistItem().mediaid);
          }),
      ...
      verify: function (e) {
        return (
          ...
          (("undefined" != typeof e.data &&
            -1 !== e.data.indexOf("cdnapi.kaltura.com")) ||
            ("undefined" != typeof e.src &&
              -1 !== e.src.indexOf("cdnapi.kaltura.com")) ||
            ("undefined" != typeof e.id &&
              -1 !== e.id.indexOf("kaltura-player")))
        );
      },
      subscribe: function (t) {
        ...
        e.util.windowSetFunction(n, function () {
          ...
          o && (i.section = o[0]),
            e.video.onPlay(n, n.evaluate("{mediaProxy.entry.id}"), i);
        }),
        ...
        var r = function () {
          ...
          e.video._storeApiRoot(t.id, r),
            r.addJsListener("playerPlayed", n),
            r.addJsListener("playerPaused", i),
            r.addJsListener("playerPlayEnd", o);
        };
        "undefined" != typeof document.getElementById(t.id).addJsListener
          ? r()
          : e.util.windowSetFunction("jsCallbackReady", r),
          e.console.log("Subscribed to Kaltura embed with ID '" + t.id + "'");
      },
    };
    ...
    var f = {
      ...
      verify: function (e) {
        return (
          -1 !== e.className.indexOf("wistia_embed") ||
          ("undefined" != typeof e.src && -1 !== e.src.indexOf("fast.wistia"))
        );
      },
      subscribe: function (t) {
        var n = function (t) {
            var n,
              i = (n = !0 === t.playlist ? t.currentVideo() : t).data.media,
              o = {
          ...
          i = function (t, n) {
            var i;
            (i = !0 === t.playlist ? t.currentVideo() : t),
              e.video.onPause(i, i.data.media.hashedId),
              !0 === n && e.video.reset(i.data.media.hashedId);
          },
          o = function (o, r) {
            if (!o) return !1;
            e.video._storeApiRoot(r, o),
              ...
              e.console.log(
                "Subscribed to Wistia embed with ID '" + t.id + "'",
              );
          };
        if ("undefined" != typeof window.Wistia) {
          ...
          return (
            r ||
              "function" != typeof window.Wistia.playlist ||
              (r = window.Wistia.playlist(t.id.split("_")[1])),
            o(r, t.id)
          );
        }
    ...
    var p = {
      ...
      verify: function (e) {
        return (
          -1 !== ["video", "video-js"].indexOf(e.tagName.toLowerCase()) &&
          (e.hasAttribute("data-video-id") ||
            e.hasAttribute("data-playlist-id"))
        );
      },
      subscribe: function (t) {
        if ("function" != typeof window.videojs)
          return (
            e.console.log(
              "Detected Brightcove embed but window.videojs is not accesible.",
            ),
            !1
          );
        var n,
          i = function (t) {
            ...
            t.el_.attributes["data-playlist-id"] &&
              t.hasOwnProperty("playlist") &&
              (i = t.playlist()[t.playlist.currentIndex()]),
              void 0 !== i
                ? ((o.pub_date_tmsp = i.publishedAt),
                  (o.title = i.name),
                  (o.tags = i.tags),
                  (n = i.id))
                : t.el_.attributes["data-video-id"] &&
                  ((n = t.el_.attributes["data-video-id"].value),
                  (o.title = t.el_.getAttribute("data-title") || undefined)),
              n
                ? e.video.onPlay(t, n, o)
                : e.console.log("No video id found for Brightcove embed!");
          },
          o = function (t, n) {
            var i;
            "undefined" != typeof t.mediainfo
              ? (i = t.mediainfo.id)
              : t.el_.attributes["data-video-id"] &&
                (i = t.el_.attributes["data-video-id"].value),
              i
                ? (e.video.onPause(t, i), !0 === n && e.video.reset(i))
                : e.console.log("No video id found for Brightcove embed!");
          },
          r = !1,
          a = function (n) {
            r ||
              ...
              (!1 === n.paused() || n.hasClass("vjs-has-started")) && i(n),
              e.console.log(
                "Subscribed to Brightcove embed with ID '" + t.id + "'",
              ));
          };
        void 0 !==
          (n =
            "undefined" != typeof window.videojs.getPlayer
              ? window.videojs.getPlayer(t.id)
              : window.videojs(t.id)) &&
          (window.isNaN(n.duration())
      ...
      verify: function (e) {
        return (
          ...
          (-1 !== e.src.indexOf("youtube.com/embed") ||
            -1 !== e.src.indexOf("youtube-nocookie.com/embed"))
        );
      },
      subscribe: function (t) {
        var n = function (t) {
          ...
          window.YT.get(t.id)
            ? (e.console.log(
                "YouTube player already initialized, using existing instance",
              ),
              (n = window.YT.get(t.id)))
            : (e.console.log("Initialized new YouTube player instance"),
              (n = new window.YT.Player(t.id))),
            ...
            n.addEventListener("onStateChange", function (t) {
              var i = function (t) {
                  var n = {};
                  return t.hasOwnProperty("getVideoData") &&
                    t.hasOwnProperty("getDuration")
                    ? (e.console.log("Youtube player using getVideoData"),
                      (n = t.getVideoData()),
                      (n.duration = t.getDuration()),
                      n)
                    : (t.hasOwnProperty("playerInfo") &&
                        (e.console.log("Youtube player using playerInfo"),
                        ((n = t.playerInfo.videoData).duration =
                          t.playerInfo.duration)),
                      n);
                },
                o = i(n).video_id;
              if (-1 === t.data || 0 === t.data || 2 === t.data)
                e.video.onPause(n, o), 0 === t.data && e.video.reset(o);
              else if (1 === t.data) {
                var r = {
        ...
        "undefined" != typeof window.YT &&
        "undefined" != typeof window.YT.Player
          ? n(t)
          : e.util.windowSetFunction("onYouTubeIframeAPIReady", function () {
              n(t);
            });
      },
    };
    (PARSELY.video._buildStrategiesList = function () {
      ...
      for (var n, i, o = 0; o < t.length; o++)
        (n = t[o]),
          (i = !0),
          "undefined" != typeof e.video.allowedStrategies &&
            -1 === e.video.allowedStrategies.indexOf(n.platform) &&
            (i = !1),
          i && e.video._strategies.push(n);
    }),
      PARSELY.video._buildStrategiesList(),
      (e.video.hasOwnProperty("autotrack") && !1 === e.video.autotrack) ||
        (o(), e.util.getWindow().setInterval(o, 5e3));
  })(),
  (function () {
    var e = this.PARSELY,
      t = e.$,
    ...
    PARSELY.Pixel = n.extend({
        ...
        if (
          ...
          var i = this,
            o = function (e) {
              ...
              var n = {};
              (n[t.flagAttribute] = e),
                d.setJSON(t.name, n, { expires: t.timeoutSecs });
            },
            r = new Image();
          (r.onerror = function () {
            o(!0);
      ...
      conversionsOverrides: function (t) {
        ...
        for (var o in i)
          if (i.hasOwnProperty(o) && n.includes(o))
            try {
              t[o] = i[o];
            } catch (r) {
              e.console.log(
                "Error overriding "
                  .concat(o, " when beaconing crossdomain conversion. Error: ")
                  .concat(r, " "),
              );
            }
      ...
      sendEvent: function (n, i) {
        ...
        var r = new Image();
        "conversion" === n.action &&
          n.hasOwnProperty("conversionOverrides") &&
          (n = this.conversionsOverrides(n)),
          (r.src = this.buildEventRequestUrl(n)),
      ...
      beacon: function (n, o, d) {
        var c = u.getSession(!0),
          ...
          p = t.extend(!0, { rand: l, plid: f }, this.data, c, n),
          v = e.visitorManager.getVisitorInfo();
        !0 === this.isThirdPartyAnalyticsBlocked() &&
          ((p.tpab = 1), (p.data.flashlight = 1)),
          s.extendVisitorExpiry();
        var g;
        for (var h in this.correlationIds)
          void 0 !== (g = this.generateEventCorrelationId(h, h === p.action)) &&
            (p[this.correlationIds[h]] = g);
        (p.data = i.stringify(p.data)),
          !0 !== o && (PARSELY.lastRequest = p),
          (r.uuid = v.id),
          this.shouldGenerateVisitorID(v.id) && this.generateVisitorID(),
          !0 === d && (e.util.isFirefox() || e.util.isSafari()) && (d = !1),
          (this.remoteEndpoint = a.pixel + this.selectEndpoint());
        var y = !1;
        !0 === d && (y = this.requestFetch(p, r.uuid)),
          !1 === y && this.sendEvent(p, r.uuid);
      },
    });
  })(),
  (function () {
    ...
    PARSELY.Beacon = i.extend({
      ...
      trackPageView: function (i, s) {
        void 0 === i && (i = {}),
          ("undefined" != typeof i.action && "pageview" !== i.action) ||
            e.initNewPage(!1);
        var u = {
          title: a.title,
          date: new Date().toString(),
        ...
        d &&
          ...
          (u.sl_h = d.href),
          d.url !== u.urlref &&
            n.log("urlref overridden by slot data as " + d.url),
          (u.urlref = d.url)),
          t.extend(u, i),
  ...
  (function () {
    ...
    for (
      var i = [
        ...
        o = function (t, i) {
          var o = { action: "conversion", data: { _conversion_type: t } };
          if (e.util.inIframe()) {
            var r = {};
            if (
              (n.location.search
                ...
                .forEach(function (t) {
                  ...
                  try {
                    ...
                    e.console.log("Error decoding ".concat(r[n[0]])),
                      (r[n[0]] = "");
                  }
                }),
              r.parselyObject)
          ...
          return (
            i
              ? "string" == typeof i ||
                i instanceof String ||
                (e.console.log(
                  "[WARN] Attempted to send Parse.ly conversions " +
                    t +
                    " event sent with non-string label; using default value instead.",
                ),
                (i = "No label provided"))
              : (e.console.log(
                  "[WARN] Attempted to send Parse.ly conversions " +
                    t +
                    " event without label; using default value instead.",
                ),
                (i = "No label provided")),
            (o.data._conversion_label = i),
            o
          );
        },
        r = function (e) {
    ...
    if (document.querySelector && document.querySelectorAll) {
      var d = function (e) {
        ...
        l = function (e, t) {
          ...
          return (
            (n.href = t),
            e.host === n.host &&
              0 === e.pathname.indexOf(n.pathname) &&
              (!(n.search.length > 0) || c(e.search, n.search))
          );
        };
      (e.conversions.ConversionFromConfigs = t.extend({
        init: function (t) {
          ...
          (this.results = []),
            (this.config = t),
            "function" == typeof (n = e.conversions[a(i.config.type)])
              ? ((this.conversionAction = function (t) {
                  d(i.config.conditions, i.config.pianoConditions, t)
                    ? e.config.customizations &&
                      !0 === e.config.customizations.debug
                      ? console.log(
                          'Debug: Conversion event would have been sent with type "'
                            .concat(i.config.type, '" and label "')
                            .concat(i.config.label || i.config.type, '".'),
                        )
                      : n(i.config.label)
                    : e.console.log(
                        "Conversion callback triggered but conditions not satisfied: ".concat(
                          i.config.conditions,
                        ),
                      );
                }),
                ...
                (this.retryInterval = i.config.retryInterval || 100),
                (this.currentUrlIsAllowed = (function () {
                  if (
                    ...
                    for (
                      var t = e.util.getWindow().location, n = 0;
                      n < i.config.allowedUrls.length;
                      n++
                    )
              ...
              : e.console.log(
                  "Configuration specified ".concat(
                    i.config.type,
                    " which is not a supported conversion type",
                  ),
                );
        },
        findMatchingElements: function () {
          var e = document;
          return (
            this.config.documentSelector &&
              document.querySelector(this.config.documentSelector) &&
              (e = document.querySelector(this.config.documentSelector)
                .contentWindow.document),
            (this.matchingElements = e.querySelectorAll(this.config.selector)),
            this
          );
        },
        addIframeArgs: function () {
          for (
            var t = n.document,
              i = t.querySelectorAll(this.config.iframeSelector),
              o = t.location.href,
              r = t.referrer,
              a = e.visitorManager.getVisitorInfo(),
              s = e.sessionManager.getSession(),
              u = {
                url: o,
                u: a.id,
                slts: s.slts,
              ...
              d = encodeURIComponent(JSON.stringify(u)),
              c = 0;
            c < i.length;
            c++
          ) {
            var l = i[c].src.split("?"),
              ...
              p = l[1],
              v = {};
            p && (v = e.util.buildNewParamsObject(p, ["parselyObject"])),
              (v.parselyObject = d);
            var g = "?";
            for (var h in v)
              v.hasOwnProperty(h) && (g += "".concat(h, "=").concat(v[h], "&"));
            if (i[c].src.includes("#")) {
              var y = i[c].src.split("#");
              i[c].src = f + g + "#" + y[1];
            } else i[c].src = f + g;
        ...
        addDigiohListeners: function () {
          var e =
              this.config.documentSelector || "iframe[id*='lightbox-iframe']",
          ...
          for (var n = 0; n < t.length; n++)
            (function i(e) {
              var t,
                n = this,
                o = e.contentWindow;
              o.BOX_CUSTOM_JS === undefined ||
              o.BOX_CUSTOM_JS.runCustomJsBeforeSubmit === undefined
                ? setTimeout(i.bind(this, e), 100)
                : ((t = o.BOX_CUSTOM_JS.runCustomJsBeforeSubmit),
                  (o.BOX_CUSTOM_JS.runCustomJsBeforeSubmit = function () {
        ...
        addPianoListeners: function () {
          var e;
          return (
            window.tp === undefined || "function" != typeof window.tp.push
              ? setTimeout(
                  this.addPianoListeners.bind(this),
                  this.retryInterval,
                )
              : ((e = [
                  "addHandler",
                  this.config.selector || "checkoutComplete",
                  this.callback,
                ]),
                window.tp.push(e),
                this.results.push(e)),
        ...
        addSkimlinksListeners: function () {
          if (
            ...
            return (
              e.console.log(
                "Skimlinks conversions not supported on this browser",
              ),
              this
            );
          var t = this,
            n = function (e, n) {
              for (var i = 0; i < e.length; i++)
                if (
                  "attributes" === e[i].type &&
                  -1 !== e[i].target.href.indexOf("go.skimresources.com")
                ) {
            ...
            i = function (t) {
              var i = { attributeFilter: ["href"], attributeOldValue: !0 };
              new MutationObserver(n).observe(t, i),
                e.console.log("Created skimlinks observer");
            };
          return (
            document.body.addEventListener(
              ...
              function (e) {
                "A" === e.target.tagName &&
                  (-1 !== e.target.href.indexOf("go.skimresources.com")
                    ? t.callback()
                    : i(e.target));
              },
              !0,
        ...
        addStandardListeners: function () {
          if (
            ...
            0 === this.matchingElements.length && !0 === this.config.poll)
          )
            return setTimeout(this.addStandardListeners.bind(this), 100), this;
          for (var e = 0; e < this.matchingElements.length; e++)
            this.matchingElements[e].addEventListener(
              this.config.event,
              this.callback,
            );
        ...
        processConversionConfig: function () {
          return this.currentUrlIsAllowed
            ? ("piano" === this.config.event
                ? this.addPianoListeners()
                : "digioh" === this.config.event
                  ? this.addDigiohListeners()
                  : "skimlinks" === this.config.event
                    ? this.addSkimlinksListeners()
                    : "load" === this.config.event
                      ? (this.results.push("onload"), this.conversionAction())
                      : this.config.hasOwnProperty("iframeSelector")
                        ? this.addIframeArgs()
                        : this.addStandardListeners(),
              e.console.log(
                "Initialized conversion configuration for ".concat(
                  this.config.event,
                  " event",
                ),
              ),
              this)
            : (e.console.log(
                "Conversion configuration skipped because URL is not allowed.",
              ),
              this);
        },
      })),
        (e.conversions.initConversionsFromConfigs = function (t) {
          var n = [];
          {
            if (Array.isArray(t.conversions)) {
              for (var i = 0; i < t.conversions.length; i++)
                n.push(
                  new e.conversions.ConversionFromConfigs(t.conversions[i]),
                );
              return n;
            }
            e.console.log(
              "PARSELY.config.customizations.conversions is not an array, so skipping conversion customizations.",
            );
          }
        }),
        e.config.customizations &&
          e.config.customizations.conversions &&
          e.conversions.initConversionsFromConfigs(e.config.customizations);
    } else
      e.console.log(
        "Configuration-defined conversions not supported on this browser",
      );
  })();
