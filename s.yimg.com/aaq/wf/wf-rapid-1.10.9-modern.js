!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    : "function" == typeof define && define.amd
      ? define("wafer-rapid", [], t)
      : "object" == typeof exports
        ? (exports["wafer-rapid"] = t())
        : ((e.wafer = e.wafer || {}),
          (e.wafer.wafers = e.wafer.wafers || {}),
          (e.wafer.wafers["wafer-rapid"] = t()));
  ...
  return (function (e) {
    ...
    "./src/entry.js": function (e, t, r) {
      ...
      var u = window.wafer.utils.get,
        ...
        p = function (e) {
          return (
            ...
            !f &&
              d &&
              (f = u(window, d)) &&
              "function" != typeof f.refreshModule &&
              ((d = null), (f = null)),
            f
          );
        },
        ...
        C = (function (e) {
          function t(e) {
            ...
            ("click" !== s && "eachClick" !== s) ||
              e.classList.add("has-rapid-click", "has-wafer-click");
            var p = e.getAttribute(I + "rapid-method"),
              ...
              _ = b[0],
              m = b[1],
              O = _ ? Math.max(Math.min(100, parseInt(_, 10)), 0) : 50,
              k = m ? Math.max(Math.min(100, parseInt(m, 10)), 0) : 50;
            return (
              (o._util = v({}, o._util, {
                elem: e,
                hasOffsetY: !!u,
                ...
                triggerMethod: p,
                triggerPercentX: isNaN(k) ? 50 : k,
                triggerPercentY: isNaN(O) ? 50 : O,
              })),
              (o._state = o._state || {}),
              "intentionalView" === s &&
                ((o._state.inViewCount = 0),
                (o._state.didLock = !1),
                (o._state.inViewTimeoutInstance = null),
                (o._util.triggerCount = h.length - 1)),
              P.forEach(function (e) {
                o[e] = o[e].bind(o);
              }),
              "onLoad" === s
                ? (o._beaconTrigger(), o.destroy())
                : "mouseenter" === s &&
                  ((o._state.mouseEnterTimeout = null), o.addEventListeners()),
              o
            );
          }
          return (
            ...
            y(t, [
                  ...
                  if (e) {
                    ...
                    if ("beaconClick" === a) e.beaconClick(l.sec, l.slk, o, l);
                      ...
                      b.emitLog({
                        name: "WaferRapid",
                        elem: c,
                        meta: { i13n: l, name: s, type: "beaconEvent" },
                      }),
                        "intentionalView" === i
                          ? e.beaconEvent(
                              "intentional view",
                              Object.assign({}, l, { ll3: s }),
                            )
                          : e.beaconEvent(s, l);
                    } else if ("beaconLinkViews" === a)
                      e.beaconLinkViews([v({}, l, { _links: [l] })]);
                    else if ("pageView" === a) {
                      var u = T(r, "data-page-i13n"),
                        f = l.spaceid,
                        d = e.getRapidAttribute("keys");
                      e.clearRapidAttribute(["keys"]),
                        e.setRapidAttribute({
                          keys: Object.assign({}, d, u),
                          spaceid: f || e.getRapidAttribute("spaceid"),
                        }),
                        e.beaconPageview(u),
                        "click" === i && this.destroy();
                    }
                  }
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  ...
                  r ||
                    n ||
                    (this._state.inViewTimeoutInstance = j(function () {
                      if (
                        ((e._state.inViewTimeoutInstance = null),
                        e._state.inViewCount > e._util.triggerCount - 1)
                      )
                        return (
                          e._beaconTrigger(), void (e._state.inViewCount = 0)
                        );
                      e._beaconTrigger(),
                        ++e._state.inViewCount,
                        e.nodeInView();
              ...
              },
              {
                ...
                value: function () {
                  ...
                  !t &&
                    r &&
                    (V(r),
                    (this._state.inViewTimeoutInstance = null),
                    (this._state.inViewCount = 0));
                },
              },
              {
                key: "handleClick",
                value: function () {
                  this._util.elem.classList.contains("has-rapid-click") &&
                    this._beaconTrigger();
                },
              },
              {
                ...
                value: function () {
                  var e = this;
                  this._destroyed ||
                    (V(this._state.mouseEnterTimeout, this),
                    (this._state.mouseEnterTimeout = j(
                      function () {
                        e._beaconTrigger();
                      },
                      100,
              ...
              },
              {
                key: "config",
                get: function () {
                  return { trigger: this._util.trigger };
                },
              },
            ]),
            t
      ...
      C.events = {
        click: [["has-rapid-click", "handleClick"]],
        mouseenter: [["_self", "handleRapidMouseEnter"]],
        mouseleave: [["_self", "handleRapidMouseLeave"]],
      };
      var A = C,
        L = (function () {
          function e(e, t) {
        ...
        Y = window.wafer.utils,
        N = Y.convertNodeListToArray,
        D = Y.elementInView,
        X = Y.getDataYlk,
        B = Y.throttle,
        F = function (e) {
          for (var t = e, r = void 0; t; )
            t.classList.contains("wafer-rapid-module") &&
              !t.getAttribute("data-wf-rapid-trigger") &&
              (r = t),
              (t = t.parentElement);
          return r;
        },
        q = function (e, t) {
          ...
          if (
            (a.isModuleTracked(s)
              ? h(s) || e.classList.contains("wafer-rapid-tracked")
                ? a.refreshModule(s)
                : (a.removeModule(s), (l = !0))
              : (l = !0),
            l)
          ) {
        ...
        z = function (e, t, r) {
          ...
          var s = X(e),
            l = s.id;
          return (
            o.isModuleTracked(l) && o.removeModule(l),
            e.classList.remove("wafer-rapid-tracked"),
            !0
          );
        },
        H = (function (e) {
          function t() {
            ...
            return (
              p(
                (
                  document.body.getAttribute("data-wf-rapid") || "rapidInstance"
                ).split("."),
              ),
              (u._state = M({}, u._state, {
                didScroll: !1,
            ...
            x(t, [
              {
                ...
                value: function (e) {
                  var t = this._state.elementInstances,
                    ...
                    n = r.instance;
                  if (n) {
                    "scrollChange" === n._util.trigger &&
                      (n._beaconTrigger(), n.destroy());
                  }
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e) {
                  if (
                    ...
                    var i = N(e.getElementsByClassName("wafer-rapid-module"));
                    i.length > 0 &&
                  ...
                  if (this._state.didScroll) {
                    ...
                    (this._state.scrollDirection = r),
                      ...
                      e.forEach(function (e) {
                        ...
                        switch (n.trigger) {
                          case "intentionalView":
                            if (D(e, { offsetX: o, offsetY: s }, S.viewport)) {
                              if (a.has(r)) return;
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  var a = N(e.getElementsByClassName("wafer-rapid-module", n));
                  a.length > 0 &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  try {
                    for (
                      var i, a = e.entries()[Symbol.iterator]();
                      !(t = (i = a.next()).done);
                      t = !0
                    ) {
                      var o = i.value,
                      ...
                      if ("intentionalView" === u._util.trigger) {
                        var f = u._util,
                          ...
                          v = f.triggerPercentY;
                        !p &&
                          (c.instance.offsetY = -parseInt(
                            (l.clientHeight * v) / 100,
                            10,
                          )),
                          !d &&
                            (c.instance.offsetX = -parseInt(
                              (l.clientWidth * h) / 100,
                              10,
                            ));
                      }
